...
its beginning when the line starts to its end when the next line starts, resting
for a moment at both ends, a short one sits at the left, and an instrumental
passage leaves the space empty.
